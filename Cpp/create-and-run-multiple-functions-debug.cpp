...
int main()
{
    ...
    vector<uint64_t> set1 = {0b1111001000110000000001000000000100001100000000001000000000000000, 0b0101001000110000000011000000001000001000000000000011000000000000, 0b1011000000010011000000000000000100001000000000001001000000000000, 0b1100000100000010000010000000000000001100000000000101000000000000};
    ...
    pair<int,int> search = complementary_search(0b0000100000000000001000100000001000000000110000001111000000000000, 2, 0b0000110000001100000000110000000011000000000011000000000000001100);
    cout << "Result of the first search: " << search.first << ", " << search.second << endl << flush;

    search = complementary_search(0b1011000101000100110000001010001010100001001010101000101000010101, 1, 0b1100000000110011000011000000001100001100000000001100000000000000);
